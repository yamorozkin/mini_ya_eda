    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-background">
      ...
      <section className="relative w-full md:w-1/2 lg:w-3/5 min-h-[300px] md:min-h-screen bg-neutral-900 overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 p-margin-page text-center md:text-left max-w-lg">
          ...
          <p className="font-body-lg text-white/80">Присоединяйтесь к тысячам любителей бургеров и получайте быструю доставку наших вкусных блюд.</p>
          <div className="hidden md:grid grid-cols-2 gap-stack-md mt-stack-lg">
            <div className="bg-white/10 backdrop-blur-md p-stack-md rounded-xl border border-white/10">
              ...
              <h3 className="font-headline-md text-white">Биыстрая доставка</h3>
      ...
      <main className="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center p-margin-page">
        <div className="max-w-md w-full mx-auto">
          <div className="mb-stack-lg text-center md:text-left">
            <h2 className="font-headline-xl text-on-surface">Присоединитесь</h2>
            <p className="font-body-lg text-secondary">Создайте аккаунт и начните заказывать</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-stack-md">
            <div className="space-y-stack-sm">
              <label className="font-label-sm text-on-surface-variant px-1" htmlFor="name">Имя</label>
              <input
                id="name"
                type="text"
                value={name}
            ...
            <div className="space-y-stack-sm">
              <label className="font-label-sm text-on-surface-variant px-1" htmlFor="confirmPassword">Подтвердите пароль</label>
              <input
                id="confirmPassword"
                type="password"
          ...
          <p className="mt-stack-lg text-center font-label-sm text-secondary">
            Уже есть аккаунт? <br/>
            <a href="/login" className="text-on-surface font-bold hover:underline">Войти</a>
          </p>
        </div>
      </main>
    </div>
